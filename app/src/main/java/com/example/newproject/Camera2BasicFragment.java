...
import com.example.newproject.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
    ...
    /**
     * A {@link CaptureCallback} that handles events related to JPEG capture.
     */
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if(afAvailableModes.length == 0 || (afAvailableModes.length == 1 && afAvailableModes[0] == CameraMetadata.CONTROL_AE_MODE_OFF)){
